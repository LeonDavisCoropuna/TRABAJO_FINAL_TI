...
class base_datos{
    ...
    function insertar_notas($datos){
        ...
        $teamoY = "etapa".$datos["parciales"];

        $queryUpdate3 = "UPDATE $teamoY SET MayorContinua='".$auxAlumnoCM."' WHERE N=1";
        $queryUpdate4 = "UPDATE $teamoY SET MayorExamen='".$auxAlumnoEM."' WHERE N=1";
        $queryUpdate5 = "UPDATE $teamoY SET MenorContinua='".$auxAlumnoCMenor."' WHERE N=1";
        $queryUpdate6 = "UPDATE $teamoY SET MenorExamen='".$auxAlumnoEMenor."' WHERE N=1";
